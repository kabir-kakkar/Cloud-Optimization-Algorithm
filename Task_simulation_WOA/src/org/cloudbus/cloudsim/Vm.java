...
public class Vm {
	...
	public boolean beingInstantiated;

	/** The mips allocation history. */
	public final List<VmStateHistoryEntry> stateHistory = new LinkedList<VmStateHistoryEntry>();

        public int Davailableram,Dusedram;
        public double Davailablemips,DusedMips;        
        public double fault=0;
        
        public List<Datacenter> datacenterlist = new ArrayList<Datacenter>();
	/**
	...
	public List<Double> getCurrentRequestedMips() {
		...
		if (isBeingInstantiated()) {
			...
			for (int i = 0; i < getNumberOfPes(); i++) {
                ...
                //System.out.print("--"+currentRequestedMips+"ll");

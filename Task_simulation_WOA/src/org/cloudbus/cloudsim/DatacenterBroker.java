...
public class DatacenterBroker extends SimEntity {
	...
	public List<? extends Cloudlet> cloudletReceivedList;

	/** The cloudlets submitted. */
	public int cloudletsSubmitted;
	...
	/** The vms destroyed. */
	public int vmsDestroyed;

	/** The datacenter ids list. */
	public List<Integer> datacenterIdsList;

	/** The datacenter requested ids list. */
	public List<Integer> datacenterRequestedIdsList;

	/** The vms to datacenters map. */
	public Map<Integer, Integer> vmsToDatacentersMap;

	/** The datacenter characteristics list. */
	public Map<Integer, DatacenterCharacteristics> datacenterCharacteristicsList;
	...
	public void processVmCreate(SimEvent ev) {
		...
		if (result == CloudSimTags.TRUE) {
			...
			getVmsCreatedList().add(VmList.getById(getVmList(), vmId));
                        //VmList.getById(getVmList(), vmId).d=0;
                       //Log.printLine(VmList.getById(getVmsCreatedList(), vmId).getHost().storage+"-"+VmList.getById(getVmsCreatedList(), vmId).getHost().ramProvisioner.availableRam+"\n");
	...
	public void submitCloudlets() {
       ...
       {             Cloudlet cloudlet=getCloudletList().get(i);
			...
			if (cloudlet.getVmId() == -1) 
                        {   System.out.print( vmid.get(i).getClass().getName());
                            int k=vmid.get(i).intValue();
	 ...
	 */
	public <T extends Cloudlet> void setCloudletSubmittedList(List<T> cloudletSubmittedList) {
	 ...
	 */
	public <T extends Cloudlet> void setCloudletReceivedList(List<T> cloudletReceivedList) {
	 ...
	 */
	public <T extends Vm> void setVmsCreatedList(List<T> vmsCreatedList) {
	...
	public void setDatacenterRequestedIdsList(List<Integer> datacenterRequestedIdsList) {
        ...
        { 
            ...
            for(int i=0;i<getCloudletList().size();i++)
            {if(i==0)
            {s=s+getCloudletList().get(i).getCloudletLength();}
            else
            {s=s+","+getCloudletList().get(i).getCloudletLength();
            }
            }
            ...
            {if(i==0)
            {s1=s1+getVmsCreatedList().get(i).mips;}
            else
            {s1=s1+","+getVmsCreatedList().get(i).mips;
            }
            }
            s=s+"]";s1=s1+"]";
            jsons="{\"VM\":"+s1+", \"vmcount\":["+getVmsCreatedList().size()+"]," +"\"tcount\":["+getCloudletList().size()+"]," +"\"task\":"+s+"}";
            //Write JSON file
...
//                }catch(Exception e){}
  ...
  public List readdata() 
        ...
        try {
                ...
                Logger.getLogger(DatacenterBroker.class.getName()).log(Level.SEVERE, null, ex);
            ...
            Iterator<String> iterator = recs.iterator();
         while(iterator.hasNext()) {
            l.add(Integer.parseInt(iterator.next())-1);
         }

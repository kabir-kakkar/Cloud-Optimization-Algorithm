 ...
 */
public class CloudSim_simulation {
	 ...
	 */
        	public static void main(String[] args) throws Throwable {
                    ...
                    simulation(datacenter, vm, task, algo);
                   
	}
                
	public static void simulation(int datacenter, int vm, int task,String algo) {
		...
		try {
			...
			int brokerId = broker.getId();
                       ...
                       cloudletList1 = createCloudlet(brokerId, task, 0); // creating 30 cloudlets

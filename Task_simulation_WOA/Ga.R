...
data=result <- fromJSON(txt="C:\\Users\\KABIR KAKKAR\\Desktop\\Major Project 8th Sem\\Task Simulation\\Task_simulation_WOA\\data.json")
vm=unlist(data["VM"])
...
write(exportJSON, "C:\\Users\\KABIR KAKKAR\\Desktop\\Major Project 8th Sem\\Task Simulation\\Task_simulation_WOA\\sample.json")
